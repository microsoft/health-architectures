...
1. In Azure Portal, go to **Home** -> **Resource groups** and find the resource group containing your Azure API for FHIR instance. Go to the resource group and click on your Azure API for FHIR instance. 
