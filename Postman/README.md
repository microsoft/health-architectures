...
3) Go to Environments in Postman, select the Environment (api-fhir or fhir-proxy) and enter in the variable information from Azure Portal (skip the `bearerToken` for now).
