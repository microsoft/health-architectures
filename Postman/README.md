...
4. Try `GET List Patients` in the `FHIR CALLS` collection and press `Send`. If the response is as shown below, this means you successfully queried Azure API for FHIR for a list of every Patient Resource stored on the FHIR server. It looks like your setup is fully functional.
