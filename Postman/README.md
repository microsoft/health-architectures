...
- `clientId` - Application (client) ID assigned in the AAD application registration for Postman 
...
- `resource` - Application (client) ID assigned in the AAD application registration for FHIR-Proxy 
