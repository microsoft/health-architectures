...
The base pre- and post- processing modules that can be configured are:
 ...
 + **PublishFHIREventPostProcess** - This processing module will publish FHIR CUD events for resources to a configured eventhub. These events can be subscribed to by any number of consumers in order to facilitate any number of orchestrated workflows (e.g. CDS, Audits, Alerts, etc.).</br>
